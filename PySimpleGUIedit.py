...
class Button(Element):
    ...
    def Update(self, text=None, button_color=(None, None), disabled=None, image_data=None, image_filename=None, visible=None, image_subsample=None, image_size=None, button_type=None):
        try:
            if text is not None:
        ...
        if button_type == BUTTON_TYPE_BROWSE_FOLDER:
            self.BType = BUTTON_TYPE_BROWSE_FOLDER
        elif button_type == BUTTON_TYPE_BROWSE_FILE:
            self.BType = BUTTON_TYPE_BROWSE_FILE
        elif button_type == BUTTON_TYPE_BROWSE_FILES:
            self.BType = BUTTON_TYPE_BROWSE_FILES
...
class ProgressBar(Element):
    ...
    def Update(self, max_value, visible=None):
        self.MaxValue = max_value
        if visible is False:
